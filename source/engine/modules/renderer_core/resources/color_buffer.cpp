...
namespace ray::renderer_core_api::resources
{
    ...
    {
        AssociateWithResource(globals::gDevice, inResource, D3D12_RESOURCE_STATE_PRESENT);
        _rtvHandle = AllocateDescriptor(D3D12_DESCRIPTOR_HEAP_TYPE_RTV);
        globals::gDevice->CreateRenderTargetView(inResource, nullptr, _rtvHandle);
    }
    ...
    void ColorBuffer::Create(u32 width, u32 height, u32 numMips, DXGI_FORMAT format, D3D12_GPU_VIRTUAL_ADDRESS address)
    {
        ...
        CreateDerivedViews(globals::gDevice, format, 1, numMips);
    }
    ...
    void ColorBuffer::CreateArray(u32 width, u32 height, u32 numMips, u32 arrayCount, DXGI_FORMAT format, D3D12_GPU_VIRTUAL_ADDRESS address)
    {
        ...
        CreateTextureResource(globals::gDevice, desc, clearValue);
        CreateDerivedViews(globals::gDevice, format, arrayCount, 1);
    }
