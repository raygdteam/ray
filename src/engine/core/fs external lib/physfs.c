...
static int handleIo_seek(PHYSFS_Io* io, PHYSFS_uint64 offset) { return PHYSFS_seek((PHYSFS_File *)io->opaque, offset); }
/* handleIo_seek */

static PHYSFS_sint64 handleIo_tell(PHYSFS_Io* io) { return PHYSFS_tell((PHYSFS_File *)io->opaque); } /* handleIo_tell */

static PHYSFS_sint64 handleIo_length(PHYSFS_Io* io) { return PHYSFS_fileLength((PHYSFS_File *)io->opaque); }
/* handleIo_length */
...
static int handleIo_flush(PHYSFS_Io* io) { return PHYSFS_flush((PHYSFS_File *)io->opaque); } /* handleIo_flush */
...
static inline size_t dirHandleRootLen(const DirHandle* h) { return h ? h->rootlen : 0; } /* dirHandleRootLen */
...
int PHYSFS_isInit(void) { return initialized; } /* PHYSFS_isInit */
...
char** PHYSFS_getCdRomDirs(void) { return doEnumStringList(__PHYSFS_platformDetectAvailableCDs); }
/* PHYSFS_getCdRomDirs */
...
const char* PHYSFS_getUserDir(void) { return __PHYSFS_getUserDir(); } /* PHYSFS_getUserDir */
...
int PHYSFS_addToSearchPath(const char* newDir, int appendToPath) { return PHYSFS_mount(newDir, NULL, appendToPath); }
/* PHYSFS_addToSearchPath */


int PHYSFS_removeFromSearchPath(const char* oldDir) { return PHYSFS_unmount(oldDir); } /* PHYSFS_removeFromSearchPath */
...
char** PHYSFS_getSearchPath(void) { return doEnumStringList(PHYSFS_getSearchPathCallback); } /* PHYSFS_getSearchPath */
...
void PHYSFS_permitSymbolicLinks(int allow) { allowSymLinks = allow; } /* PHYSFS_permitSymbolicLinks */


int PHYSFS_symbolicLinksPermitted(void) { return allowSymLinks; } /* PHYSFS_symbolicLinksPermitted */
...
int PHYSFS_exists(const char* fname) { return (getRealDirHandle(fname) != NULL); } /* PHYSFS_exists */
...
PHYSFS_File* PHYSFS_openWrite(const char* filename) { return doOpenWrite(filename, 0); } /* PHYSFS_openWrite */


PHYSFS_File* PHYSFS_openAppend(const char* filename) { return doOpenWrite(filename, 1); } /* PHYSFS_openAppend */
